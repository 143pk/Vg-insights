    ...
    <div id="mobile-sidebar-drawer" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs hidden lg:hidden transition-opacity duration-300">
      <div class="w-80 max-w-[85vw] h-full bg-white dark:bg-slate-900 shadow-2xl flex flex-col justify-between overflow-y-auto transform transition-transform duration-300">
        ...
        <div class="p-5 space-y-6">
          ...
          <!-- Direct APK Download & Platform Overview -->
          <div class="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-2">
            <a
              href="/vg-insights.apk"
              download="vg-insights.apk"
              class="flex items-center justify-between px-3 py-2.5 rounded-lg text-xs font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900/50 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 transition-colors"
            >
              <span class="flex items-center gap-2">
                <span>📥</span>
                <span>Download Android APK</span>
              </span>
              <span class="text-[10px] px-1.5 py-0.5 rounded bg-emerald-200/60 dark:bg-emerald-800/60 text-emerald-800 dark:text-emerald-200 font-bold">.apk</span>
            </a>
